...
- **`MODEL-RUST`:** required on substantive `/fix`|`/make`|`/feature`|`/plan` close-out (`hits` cite, `none`, `unavailable`, or `skip` only for pure ack/confirm).
